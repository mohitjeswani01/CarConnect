...
import { Calendar, Clock, Users, Car, ArrowRight } from "lucide-react";
...
interface RideCardProps {
  ride: {
    ...
    driver: {
      name: string;
      avatar: string;
      rating: string | number; // Allow rating to be a string or number
    };
  };
  index: number;
...
const RideCard: React.FC<RideCardProps> = ({ ride, index, onBookRide }) => {
  ...
  const driverRating = typeof ride.driver.rating === "string"
    ? parseFloat(ride.driver.rating)
    : ride.driver.rating;
            ...
            <div className="flex items-center space-x-1">
              {[...Array(5)].map((_, i) => (
                <svg
                  ...
                  height="12"
                  viewBox="0 0 24 24"
                  fill={i < driverRating ? "#FFD700" : "#E2E8F0"}
